...
public class AppProperties {
    ...
    public static class Metrics {
        ...
        public AppProperties.Metrics.Jmx getJmx() {
            return this.jmx;
        }

        public AppProperties.Metrics.Logs getLogs() {
            return this.logs;
        }
    ...
    public static class Gateway {
        ...
        private Map<String, List<String>> authorizedMicroservicesEndpoints = Defaults.Gateway
    ...
    public static class Application {
        private String name = Defaults.Application.name;
        private String version = Defaults.Application.version;
